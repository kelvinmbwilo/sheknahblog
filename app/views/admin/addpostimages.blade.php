...
<p>{{ $post->discr }}</p>
<h4>Add Images</h4>
<span class="help-block">Do not add more than three images per post</span>
<!-- The file upload form used as target for the file upload widget -->
    <form id="fileupload" action="route('addimages')" method="POST" enctype="multipart/form-data">
