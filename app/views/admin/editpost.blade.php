...
<div class='form-group'>
    <div class='col-sm-10'>Title / Event Name <br>{{ Form::text('name',$post->name,array('class'=>'form-control','placeholder'=>'Title / Event Name','required'=>'required')) }} </div>
</div>
...
@else
<div class='form-group'>
    <div class='col-sm-10'>Category<br>{{ Form::select('category',Category::lists('name','id'),$post->category,array('class'=>'form-control')) }}  </div>
</div>
@endif

<div class='form-group'>
    <div class='col-sm-10'>Discription{{ Form::textarea('discr',$post->discr,array('class'=>'form-control','placeholder'=>'Discription','required'=>'required')) }} </div>
</div>
